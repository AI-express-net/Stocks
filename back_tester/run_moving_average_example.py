...
def run_moving_average_example():
    ...
    config = BackTesterConfig({
        ...
        'portfolio_file': 'moving_average_portfolio.json',
        'transactions_file': 'moving_average_transactions.json'
    })
    ...
    # Export results
    back_tester.export_results('moving_average_results.json')
    print(f"\nResults exported to: moving_average_results.json")
...
def run_with_real_data():
    ...
    config = BackTesterConfig({
        ...
        'portfolio_file': 'real_moving_average_portfolio.json',
        'transactions_file': 'real_moving_average_transactions.json'
    })
